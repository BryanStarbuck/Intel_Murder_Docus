...
Marc Angelucci's murder is directly connected to the attack on Judge [Esther Salas](Esther_Salas.md)'s family — the FBI confirmed the same .380 caliber handgun was used in both shootings, and the same man, [Roy Den Hollander](Roy_Den_Hollander.md), carried out both attacks using the same FedEx delivery driver disguise. Angelucci himself had no known connection to [Jeffrey Epstein](Jeffrey_Epstein.md). His inclusion here is based entirely on the fact that his killer also targeted the judge overseeing the Epstein-Deutsche Bank lawsuit. The central unresolved question is whether Den Hollander was truly acting alone as a disgruntled litigant, or whether the Angelucci killing was part of a broader operation in which the Salas attack was the primary objective.
...
- [Daniel Anderl](Daniel_Anderl.md) — Son of Judge Esther Salas, killed by the same gunman eight days later
- [Esther Salas](Esther_Salas.md) — Federal judge assigned to the Epstein-Deutsche Bank case whose family was attacked
- [Thomas Bowers](Thomas_Bowers.md) — Deutsche Bank executive who handled Epstein's accounts, found hanged
