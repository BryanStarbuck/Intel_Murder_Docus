...
description: "Clinton aide who admitted Epstein to White House, found hanged and shot under sealed circumstances."
keywords: ["Mark Middleton", "Jeffrey Epstein", "Ghislaine Maxwell", "sex trafficking", "blackmail", "elite trafficking ring", "Epstein network", "suspicious death", "intelligence murder", "cover-up"]
sidebar_label: "Mark Middleton"
...
1. The initial police report, authored by Perry County Sheriff's Deputy Jeremy Lawson, noted a gun case and up to three boxes of 12-gauge buckshot found inside Middleton's BMW — **but no gun was found anywhere at the scene.**
2. A later, second set of documents released to the Daily Mail revealed that a Stoeger 12-gauge coach gun (a short-barreled double-barreled shotgun) was found on the ground **approximately 30 feet from the body.**
3. This is a direct contradiction between the initial police report (no weapon found) and the subsequent document release (weapon found 30 feet away).
4. A self-inflicted shotgun blast to the chest would typically result in the weapon falling very close to or beneath the body, not 30 feet away.
...
## Connection to [Jeffrey Epstein](Jeffrey_Epstein.mdx)
...
- Epstein donated $10,000 to the White House Historical Association in 1993 and, accompanied by [Ghislaine Maxwell](Ghislaine_Maxwell.mdx), attended a Clinton donors' reception.
...
- [Jean-Luc Brunel](Jean_Luc_Brunel.mdx) — February 2022 (hanging in prison)
- [Steven Hoffenberg](Steven_Hoffenberg.mdx) — August 2022 (found dead in apartment)
- [Anne Heche](Anne_Heche.mdx) — August 2022 (car crash)
- [Kenneth Starr](Kenneth_Starr.mdx) — September 2022 (surgical complications)
- [Nikolai Mushegian](Nikolai_Mushegian.mdx) — October 2022 (drowning)
- [John Connolly](John_Connolly.mdx) — January 2022 (natural causes)
- [Steve Bing](Steve_Bing.mdx) — Also a Clinton associate, fell from building

- [Christopher Sign](Christopher_Sign.mdx) — Reporter who broke the Clinton-Lynch tarmac story; found dead of gunshot in 2021
- [Ashley Haynes](Ashley_Haynes.mdx) — Found drowned in Arkansas River with concrete block tied to ankle by extension cord, four months before Middleton

See also: [Jeffrey Epstein](Jeffrey_Epstein.mdx) | [Ghislaine Maxwell](Ghislaine_Maxwell.mdx) | [Thomas Bowers](Thomas_Bowers.mdx)
