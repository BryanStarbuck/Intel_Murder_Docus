...
- Her death fits the broader pattern of individuals who publicly accused powerful entertainment industry figures dying before their full stories were told (see [Isaac Kappy](Isaac_Kappy.mdx), [Chris Cornell](Chris_Cornell.mdx), [Chester Bennington](Chester_Bennington.mdx))
...
- **[Isaac Kappy](Isaac_Kappy.mdx)** — Actor who publicly named Hollywood pedophiles in 2018. Said "if I die, it wasn't suicide." Fell from an Arizona bridge in May 2019.
...
- [Isaac Kappy](Isaac_Kappy.mdx) — Actor who named Hollywood pedophiles, fell from bridge
