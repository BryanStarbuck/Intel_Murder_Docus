...
description: "Convicted sex trafficker found hanged in federal jail awaiting trial under deeply suspicious circumstances."
keywords: ["Jeffrey Epstein", "Jeffrey Epstein", "Ghislaine Maxwell", "sex trafficking", "blackmail", "elite trafficking ring", "Epstein network", "suspicious death", "intelligence murder", "cover-up"]
sidebar_label: "Jeffrey Epstein"
...
- [Ghislaine Maxwell](Ghislaine_Maxwell.mdx) — Only convicted co-conspirator, serving 20 years
- [Jean-Luc Brunel](Jean_Luc_Brunel.mdx) — Found hanged in Paris prison, same method
- [Thomas Bowers](Thomas_Bowers.mdx) — Deutsche Bank wealth chief, found hanged 3 months later
- [Mark Middleton](Mark_Middleton.mdx) — Clinton aide who admitted Epstein to White House
- [Steven Hoffenberg](Steven_Hoffenberg.mdx) — Business partner who confessed about blackmail operation
- [Virginia Giuffre](Virginia_Giuffre.mdx) — Most prominent accuser
- [Alfredo Rodriguez](Alfredo_Rodriguez.mdx) — House manager who stole the "black book"
- [Efrain "Stone" Reyes](Efrain_Stone_Reyes.mdx) — Last cellmate, transferred out one day before death
- [Arthur Shapiro](Arthur_Shapiro.mdx) — Predecessor whose murder created Epstein's opening
- [Joe Recarey](Joe_Recarey.mdx) — Lead detective on the original investigation
