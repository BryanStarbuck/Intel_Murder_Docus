...
description: "Celebrity chef and vocal abuse advocate, found hanged in France with no warning signs."
keywords: ["Anthony Bourdain", "Jeffrey Epstein", "Ghislaine Maxwell", "sex trafficking", "blackmail", "elite trafficking ring", "Epstein network", "suspicious death", "intelligence murder", "cover-up"]
...
- Fits the exact 2017–2018 suicide cluster with [Avicii](Avicii_Tim_Bergling.mdx), [Cornell](Chris_Cornell.mdx), and [Bennington](Chester_Bennington.mdx)
- All allegedly silenced for the same documentary project
- Repeated hanging method — matching [Epstein](Jeffrey_Epstein.mdx), [Brunel](Jean_Luc_Brunel.mdx), [Cornell](Chris_Cornell.mdx), [Bennington](Chester_Bennington.mdx), [Middleton](Mark_Middleton.mdx), and [Bowers](Thomas_Bowers.mdx)
...
## See Also
- [Chris Cornell](Chris_Cornell.mdx) — 2017-2018 death cluster; both allegedly linked to trafficking documentary
- [Chester Bennington](Chester_Bennington.mdx) — 2017-2018 death cluster; same hanging method
- [Avicii (Tim Bergling)](Avicii_Tim_Bergling.mdx) — 2017-2018 death cluster; died weeks before Bourdain
- [Kate Spade](Kate_Spade.mdx) — Died by hanging three days before Bourdain in June 2018
- [Jeffrey Epstein](Jeffrey_Epstein.mdx) — Central figure in the trafficking network Bourdain allegedly threatened
- [Jean-Luc Brunel](Jean_Luc_Brunel.mdx) — Another hanging death in Epstein network
