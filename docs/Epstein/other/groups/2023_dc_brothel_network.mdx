...
**Montgomery Blair Sibley**, the former lawyer for [Deborah Jeane Palfrey](../../../Details/Deborah_Jeane_Palfrey.mdx), publicly drew comparisons between the two cases:
...
- [Washington DC Area](../locations/washington_dc.mdx) — Virginia brothels near CIA/Pentagon corridor
- [Other U.S. Locations](../locations/other_us.mdx) — Boston-area locations in Cambridge and Watertown, MA
