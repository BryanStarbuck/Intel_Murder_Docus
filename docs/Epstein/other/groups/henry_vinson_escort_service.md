...
For full details, see [Craig Spence Operation](craig_spence.md).
...
The Vinson escort service operation overlaps with the [Franklin scandal](franklin_scandal.md) in several ways:
...
Vinson's operation and [Palfrey's operation](dc_madam.md) were **separate** — they operated in different decades (1986–1989 vs. 1993–2006) and served different clienteles (Vinson's was exclusively male; Palfrey's provided female escorts). However, the parallels are striking:
...
* **Intelligence connections**: Both involved alleged [CIA](cia.md)/[Mossad](mossad.md) asset involvement (Spence for Vinson's operation; [Ghislaine Maxwell](/epstein-murders/Details/Ghislaine_Maxwell)/[Robert Maxwell](/epstein-murders/Details/Robert_Maxwell) for Epstein's)
...
* **Craig Spence** — Biggest client; alleged CIA asset; spent $20,000/month; **found dead November 10, 1989** at Boston Ritz-Carlton. See [Craig Spence Operation](craig_spence.md)
...
* The broader web of connected operations includes additional suspicious deaths — see [Craig Spence Operation](craig_spence.md), [DC Madam Operation](dc_madam.md), and [Franklin Scandal](franklin_scandal.md).
...
- [Bohemian Grove](bohemian_grove.md) — Elite retreat where CIA directors (including Casey, an alleged client) gave briefings
- [Craig Spence Operation](craig_spence.md) — Biggest client; ran wired blackmail residence with Vinson's escorts
- [Franklin Scandal](franklin_scandal.md) — Overlapping participants; reporter confirmed Spence-Larry King connections
- [DC Madam](dc_madam.md) — Later DC sex operation with same pattern of sealed client lists
- [2023 DC Brothel Network](2023_dc_brothel_network.md) — Modern DC operation; same pattern of powerful clients shielded
- [CIA](cia.md) — CIA Director Casey and NSC adviser Gregg allegedly clients
