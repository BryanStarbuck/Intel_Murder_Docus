...
- Together with the [DC Madam](dc_madam.md) ([Deborah Jeane Palfrey](/epstein-murders/Details/Deborah_Jeane_Palfrey)), [Henry Vinson Escort Service](henry_vinson_escort_service.md), and [Franklin scandal](franklin_scandal.md), the Spence case shows decades of politically compromising sex operations in Washington DC
...
- [Bohemian Grove](bohemian_grove.md) — Elite retreat where Franklin victim Bonacci testified about abuse; same CIA networks
- [Franklin Scandal](franklin_scandal.md) — Child trafficking ring with overlapping participants and intelligence connections
- [Henry Vinson Escort Service](henry_vinson_escort_service.md) — Supplied escorts to Spence; CIA Director Casey allegedly a client
- [DC Madam](dc_madam.md) — Later DC sex operation with same pattern of operator death and suppressed client lists
- [CIA](cia.md) — Spence claimed CIA affiliation; residence allegedly wired by intelligence agents
- [Jeffrey Epstein Network](jeffrey_epstein_network.md) — Successor operation using same wired-property blackmail techniques
