...
* **Intelligence connections**: Both involved alleged [CIA](cia.mdx)/[Mossad](mossad.mdx) asset involvement (Spence for Vinson's operation; [Ghislaine Maxwell](../../../Details/Ghislaine_Maxwell.mdx)/[Robert Maxwell](../../../Details/Robert_Maxwell.mdx) for Epstein's)
...
- [Washington DC Area](../locations/washington_dc.mdx) — Base of operations; Chevy Chase apartment, Carlyle Suites Hotel, Spence's Kalorama mansion, White House tours
