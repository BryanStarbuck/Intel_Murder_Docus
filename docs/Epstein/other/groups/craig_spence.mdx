---
title: "Craig Spence Operation"
description: "DC lobbyist who ran midnight White House tours with male prostitutes in the 1980s; connected to the Franklin scandal; found dead in a hotel room."
keywords: ["Craig Spence Operation", "Jeffrey Epstein", "Ghislaine Maxwell", "sex trafficking", "blackmail", "elite trafficking ring", "Epstein network", "intelligence cover-up"]
sidebar_label: "Craig Spence Operation"
...
* Spent up to **$20,000/month** on male prostitutes from [Henry Vinson](henry_vinson_escort_service.mdx)'s DC escort service
...
* **[Henry Vinson](henry_vinson_escort_service.mdx)** — Operator of DC's largest male escort service; supplied escorts to Spence; later wrote *Confessions of a D.C. Madam* (2015, with Nick Bryant) detailing the blackmail operation
* **Reginald deGueldre** — White House guard who authorized the midnight tours
* Connection to [Franklin scandal](franklin_scandal.mdx) figures — Paul Bonacci, a Franklin victim, alleged he was taken to Washington DC parties that overlapped with Spence's network; Washington Times reporter Paul Rodriguez confirmed: "I had been told by several prostitutes along with law enforcement that there were connections between Craig Spence and Larry King"
...
- Both had alleged intelligence connections ([CIA](cia.mdx), [Mossad](mossad.mdx))
...
- Together with the [DC Madam](dc_madam.mdx) ([Deborah Jeane Palfrey](/epstein-murders/Details/Deborah_Jeane_Palfrey)), [Henry Vinson Escort Service](henry_vinson_escort_service.mdx), and [Franklin scandal](franklin_scandal.mdx), the Spence case shows decades of politically compromising sex operations in Washington DC
...
- [Washington DC Area](/epstein-murders/other/more/locations/washington_dc) — Spence's Kalorama mansion and White House tours
- [Omaha, Nebraska](/epstein-murders/other/more/locations/omaha_nebraska) — Connected to the Franklin scandal network

## See Also

- [Bohemian Grove](bohemian_grove.mdx) — Elite retreat where Franklin victim Bonacci testified about abuse; same CIA networks
- [Franklin Scandal](franklin_scandal.mdx) — Child trafficking ring with overlapping participants and intelligence connections
- [Henry Vinson Escort Service](henry_vinson_escort_service.mdx) — Supplied escorts to Spence; CIA Director Casey allegedly a client
- [DC Madam](dc_madam.mdx) — Later DC sex operation with same pattern of operator death and suppressed client lists
- [CIA](cia.mdx) — Spence claimed CIA affiliation; residence allegedly wired by intelligence agents
- [Jeffrey Epstein Network](jeffrey_epstein_network.mdx) — Successor operation using same wired-property blackmail techniques

## Sources

- [Wikipedia: Craig Spence](https://en.wikipedia.org/wiki/Craig_Spence)
- [The Washington Times: Homosexual prostitution inquiry ensnares VIPs with Reagan, Bush (June 29, 1989)](https://archive.org/details/HomosexualProstitutionInquiryEnsnaredVIPsWithReaganBush)
