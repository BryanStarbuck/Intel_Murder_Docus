---
title: "Natalya Estemirova"
description: "Russian human rights activist and leading investigator for the Memorial Human Rights Centre, who spent over a decade documenting extrajudicial killings, torture, and forced disappearances in Chechnya."
keywords: ["Natalya Estemirova", "intelligence service", "CIA", "MI6", "Mossad", "KGB", "FSB", "GRU", "political assassination", "journalist murder", "scientist murder", "intelligence agency", "declassified", "suspicious death"]
sidebar_label: "Natalya Estemirova"
...
- [Anna Politkovskaya](Anna_Politkovskaya.mdx) — Journalist and close colleague, murdered 2006
- [Stanislav Markelov](Stanislav_Markelov.mdx) — Human rights lawyer and colleague, murdered January 2009
- [Anastasia Baburova](Anastasia_Baburova.mdx) — Journalist killed alongside Markelov
- [Boris Nemtsov](Boris_Nemtsov.mdx) — Opposition leader shot near Kremlin, 2015 (also by Chechen operatives)
- [Paul Klebnikov](Paul_Klebnikov.mdx) — Forbes Russia editor murdered, 2004
- [Dmitry Kholodov](Dmitry_Kholodov.mdx) — Russian journalist killed by a briefcase bomb in 1994; his murder established the pattern of journalists investigating Russian military/intelligence being killed with impunity

## Other Shocking Stories

- [Max Spiers](https://intelligencemurders.com/intelligence-service-murders/Details/Max_Spiers/): Texted his mother 'if anything happens, investigate.' Vomited two litres of black fluid and died in Warsaw.
...
- [Natalya Estemirova — Wikipedia](https://en.wikipedia.org/wiki/Natalya_Estemirova)
- ['She Was An Inconvenience': Remembering Natalya Estemirova 15 Years After Her Killing — RFE/RL](https://www.rferl.org/a/estemirova-chechnya-kadyrov-atrocities-abuses-killing/33037273.html)
- [Justice Is Never Too Late — Human Rights Watch](https://www.hrw.org/news/2019/07/15/justice-never-too-late-natalya-estemirova-russian-activist-killed-10-years-ago)
- [Russia: Leading Rights Activist Murdered — HRW](https://www.hrw.org/news/2009/07/15/russia-leading-chechnya-rights-activist-murdered)
- [10 Years Since Killing — Amnesty International](https://www.amnesty.org/en/latest/news/2019/07/russia-10-years-since-the-killing-of-chechen-human-rights-defender-natalia-estemirova-no-justice-in-sight-2/)
- [ECHR: Russia Failed to Properly Investigate Estemirova Murder — The Moscow Times](https://www.themoscowtimes.com/2021/08/31/russia-failed-to-properly-investigate-activist-estemirovas-murder-echr-rules-a74941)
- [European Court Faults Russia In Estemirova Murder Case — RFE/RL](https://www.rferl.org/a/european-court-russia-estemirova/31437207.html)
- [ECHR Estemirova v Russia — EHRAC](https://ehrac.org.uk/en_gb/key-ehrac-cases/estemirova-v-russia/)
