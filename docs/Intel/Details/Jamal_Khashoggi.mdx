...
description: "Saudi dissident journalist murdered and dismembered inside the Saudi consulate in Istanbul by a 15-member Saudi hit squad on October 2, 2018. The CIA concluded with high confidence that Crown Prince Mohammed bin Salman ordered the operation."
keywords: ["Jamal Khashoggi", "intelligence service", "CIA", "MI6", "Mossad", "KGB", "FSB", "GRU", "political assassination", "journalist murder", "scientist murder", "intelligence agency", "declassified", "suspicious death"]
sidebar_label: "Jamal Khashoggi"
