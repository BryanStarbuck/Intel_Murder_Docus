...
[Mark Clark](Mark_Clark.md), a 22-year-old Panther leader from Peoria, Illinois, was also killed in the raid. The four surviving Panthers who were present — including the wounded — were initially charged with attempted murder of the police officers.
...
- [Mark Clark](Mark_Clark.md) — Black Panther leader from Peoria, killed alongside Hampton in the same raid; only 22 years old
- [John Lennon](John_Lennon.md) — another activist figure tracked extensively by FBI surveillance and COINTELPRO-era intelligence operations
- [Pat Tillman](Pat_Tillman.md) — killed by own forces with subsequent government cover-up
