---
title: "Juan Jose Torres"
description: "Former president of Bolivia, progressive military leader who nationalized mines and created a People's Assembly, overthrown in a CIA-backed coup by Hugo Banzer, then hunted across South America and assassinated in Buenos Aires in 1976 as part of Operation Condor."
keywords: ["Juan Jose Torres", "intelligence service", "CIA", "MI6", "Mossad", "KGB", "FSB", "GRU", "political assassination", "journalist murder", "scientist murder", "intelligence agency", "declassified", "suspicious death"]
sidebar_label: "Juan Jose Torres"
...
- [Zelmar Michelini](Zelmar_Michelini.mdx) — Uruguayan senator murdered in Buenos Aires the previous month
- [Hector Gutierrez Ruiz](Hector_Gutierrez_Ruiz.mdx) — Uruguayan legislator murdered alongside Michelini
- [Carlos Prats](Carlos_Prats.mdx) — Chilean general assassinated by DINA in Buenos Aires, 1974
- [Orlando Letelier](Orlando_Letelier.mdx) — Chilean diplomat killed by DINA car bomb in Washington DC, 1976
- [Che Guevara](Che_Guevara.mdx) — Argentine-Cuban revolutionary killed in Bolivia with CIA assistance, 1967
...
- [Hector Gutierrez Ruiz](Hector_Gutierrez_Ruiz.mdx): Former Speaker of Uruguay's parliament, kidnapped, tortured, and shot in Buenos Aires. Operation Condor.
...
- [Juan Jose Torres — Wikipedia](https://en.wikipedia.org/wiki/Juan_Jos%C3%A9_Torres)
...
- [Torres, Juan Jose (1921-1976) — Encyclopedia.com](https://www.encyclopedia.com/humanities/encyclopedias-almanacs-transcripts-and-maps/torres-juan-jose-1921-1976)
- [1971 Bolivian coup d'etat — Wikipedia](https://en.wikipedia.org/wiki/1971_Bolivian_coup_d'%C3%A9tat)
- [Hugo Banzer — Wikipedia](https://en.wikipedia.org/wiki/Hugo_Banzer)
