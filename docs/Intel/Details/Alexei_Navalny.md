...
- **Pattern of FSB poisonings:** The Navalny case fits within the documented FSB pattern of using exotic poisons against dissidents — [Litvinenko](Alexander_Litvinenko.md) (polonium-210), [Skripal](Sergei_Skripal.md) (Novichok), Vladimir Kara-Murza (unidentified toxin, twice survived).
...
- [Anna Politkovskaya](Anna_Politkovskaya.md) — Journalist critical of Putin and the Chechen wars, shot dead in her apartment building on Putin's birthday, 2006. Like Navalny, she had survived a prior poisoning attempt.
- [Sergei Magnitsky](Sergei_Magnitsky.md) — Whistleblower who exposed a $230 million tax fraud scheme and died in Russian prison after being denied medical care, 2009
- [Natalya Estemirova](Natalya_Estemirova.md) — Human rights activist in Chechnya, abducted and killed, 2009
