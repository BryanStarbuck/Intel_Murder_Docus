---
title: Barry Sherman
description: "Canadian billionaire founder of generic-drug giant Apotex, found dead alongside his wife Honey in their Toronto mansion in December 2017. Initially treated as a possible murder-suicide; reclassified by Toronto Police as a \"targeted double homicide\" six weeks later. The case remains unsolved."
keywords: ["Barry Sherman", "intelligence service", "CIA", "MI6", "Mossad", "KGB", "FSB", "GRU", "political assassination", "journalist murder", "scientist murder", "intelligence agency", "declassified", "suspicious death"]
sidebar_label: "Barry Sherman"
...
| Field | Details |
|-------|---------|
| **Full Name** | Bernard Charles "Barry" Sherman |
| **Born** | February 25, 1942 |
| **Died** | December 13, 2017 (bodies discovered December 15, 2017) |
| **Age at Death** | 75 |
| **Location of Death** | 50 Old Colony Road, North York, Toronto, Ontario, Canada |
| **Cause of Death** | Ligature compression of the neck (strangulation by belt around the neck) |
| **Official Ruling** | Targeted double homicide (Toronto Police, January 26, 2018) |
| **Nationality** | Canadian |
| **Killed on US Soil** | No |
| **Alleged Intelligence Connection** | None established. Speculation in social media posts (e.g., [@LightOnLiberty on X](https://x.com/LightOnLiberty/status/2050723603319030010), May 2, 2026) has tied the murders to subsequent suppression of hydroxychloroquine during COVID-19; this connection has not been substantiated by police, prosecutors, or any credible investigation |
| **Victim Was Intel Employee** | No |
| **Category** | Civilian / Pharmaceutical Industry |
...
Beginning in 2020, social-media posts — including the [May 2, 2026 post](https://x.com/LightOnLiberty/status/2050723603319030010) by **@LightOnLiberty** that prompted this entry — have raised questions about whether the Sherman murders relate to subsequent events around the COVID-19 pandemic and hydroxychloroquine.
...
> "Who murdered Barry and Honey Sherman — owners of Canadian company Apotex — Canada's ONLY manufacturer for cheaper and more effective Hydroxychloroquine? They were brutally murdered in their home before the Covid-19 pandemic was released and Hydroxychloroquine was demonized!" — [@LightOnLiberty on X](https://x.com/LightOnLiberty/status/2050723603319030010), May 2, 2026 *(an unverified social-media claim raising questions; not a finding of any investigation)*
...
- [Barry Sherman — Wikipedia](https://en.wikipedia.org/wiki/Barry_Sherman)
- [Murders of Barry and Honey Sherman — Wikipedia](https://en.wikipedia.org/wiki/Murders_of_Barry_and_Honey_Sherman)
- [Toronto Police announce Sherman case is "targeted double homicide" — CBC](https://www.cbc.ca/news/canada/toronto/sherman-targeted-killings-1.4505921)
- [Inside the Sherman murder mystery — Toronto Life](https://torontolife.com/city/inside-sherman-murder-mystery/)
- [Police release person-of-interest video in Sherman case — CBC](https://www.cbc.ca/news/canada/toronto/sherman-murder-update-1.6240093)
- [Apotex Inc. — Wikipedia](https://en.wikipedia.org/wiki/Apotex)
- [Sherman family offers $10M reward — Globe and Mail](https://www.theglobeandmail.com/canada/article-sherman-family-offers-10-million-reward/)
- [@LightOnLiberty on X (May 2, 2026)](https://x.com/LightOnLiberty/status/2050723603319030010) — social-media post raising questions about Apotex, hydroxychloroquine, and the timing of the murders
