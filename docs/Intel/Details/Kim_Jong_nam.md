...
- [Georgi Markov](Georgi_Markov.md) — Bulgarian dissident assassinated with ricin pellet in London, another state-sponsored poisoning of an exile critic
- [Alexander Litvinenko](Alexander_Litvinenko.md) — Russian defector killed by polonium-210 poisoning in London, a parallel case of a chemical/radiological assassination on foreign soil
- [Sergei Skripal](Sergei_Skripal.md) — Russian double agent targeted with Novichok nerve agent in Salisbury, England; survived the attack
