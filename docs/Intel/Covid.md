---
title: COVID-19 and the Intelligence Murders Investigation
sidebar_label: COVID-19
sidebar_position: 12
description: "Documenting the cluster of suspicious deaths, suppressed treatment debates, retaliated-against whistleblowers, and contested scientific claims surrounding the COVID-19 pandemic — and how they intersect with intelligence service involvement."
keywords: ["COVID-19", "pandemic deaths", "whistleblower suppression", "lab leak", "intelligence cover-up", "scientific suppression", "treatment debate"]
...
Beginning in 2020, **social-media commentary** — including the [May 2, 2026 post by @LightOnLiberty](https://x.com/LightOnLiberty/status/2050723603319030010) that prompted this page — has speculated about a connection between the Sherman murders and the subsequent public dispute over hydroxychloroquine during COVID-19. **No criminal investigation, official inquiry, or peer-reviewed source has substantiated such a connection.** The Toronto Police have made no public statement linking the murders to pharmaceuticals, hydroxychloroquine, or the pandemic.
...
- [@LightOnLiberty on X (May 2, 2026)](https://x.com/LightOnLiberty/status/2050723603319030010) — original social-media post raising the Apotex / hydroxychloroquine timing question
...
- [FDA revokes EUA for hydroxychloroquine — FDA, June 15, 2020](https://www.fda.gov/news-events/press-announcements/coronavirus-covid-19-update-fda-revokes-emergency-use-authorization-chloroquine-and)
- [Mehra et al. retraction — The Lancet](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(20)31324-6/fulltext)
