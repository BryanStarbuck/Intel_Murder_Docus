...
*Sorted by suspicion level (most suspicious first), then by severity of harm.*
...
*Sorted by suspicion level (most suspicious first), then by severity of harm (killed above survived).*
